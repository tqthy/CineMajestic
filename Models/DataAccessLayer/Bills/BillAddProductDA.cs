        ...
        public long GetOutcomeByMonth(string month)
        {
            ...
            try
            {
                ...
                using (var command = new SqlCommand())
                {
                    ...
                    command.CommandText = "SELECT Total FROM [Bill_AddProductTest] WHERE MONTH(BillDate)=@month AND YEAR(BillDate)=YEAR(GETDATE())";
        ...
        public long GetOutcomeByYear(string year)
        {
            ...
            try
            {
                ...
                using (var command = new SqlCommand())
                {
                    connection.Open();
                    command.Connection = connection;
                    command.CommandText = "SELECT Total FROM [Bill_AddProductTest] WHERE YEAR(BillDate)=@year";
